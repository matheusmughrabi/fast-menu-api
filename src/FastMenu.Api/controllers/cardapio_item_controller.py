...
def registrar_cardapio_item_rotas(app: OpenAPI):
    ...
    @app.patch('/cardapio-item/atualizar-nome', tags=[cardapio_item_tag], responses={"200": None, "404": ErrorSchema, "400": ErrorSchema})
    ...
    @app.delete('/cardapio-item/deletar', tags=[cardapio_item_tag], responses={"200": None, "404": ErrorSchema})
